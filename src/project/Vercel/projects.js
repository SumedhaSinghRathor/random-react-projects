...
const projects = [
  ...
  {
    title: "QuantaSight",
    desc: "Medical Dashboard for visualizing medical data, built with React. It is a front-end application that allows users to explore and analyze medical datasets.",
    name: "quantasight",
