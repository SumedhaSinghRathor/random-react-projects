...
function KanbanBoard() {
  const [columns, setColumns] = useState(animes);

  const [newTask, setNewTask] = useState("");
  const [activeColumn, setActiveColumn] = useState("interestedIn");
    ...
    >
      ...
      <div className="border flex p-2 gap-2 items-center mt-3">
        <input
          ...
          className="grow px-2 py-1 border rounded outline-0 text-end"
